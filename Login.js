        ...
        <Content>
          ...
          >
            <View style={{backgroundColor:'#f9f9f9', height:250, width:300, alignSelf:'center', marginTop:"50%"}}>
              <Item regular style={{height:30, width:200, alignSelf:'center', marginTop:"20%", backgroundColor:"#FFFFFf"}}>
              ...
              <Item regular style={{height:30, width:200, alignSelf:'center', marginTop:7, backgroundColor:"#FFFFFf"}}>
                <Input style={{fontSize:12, textAlign:'center'}} placeholder="Password" onChangeText={(Password)=>this.setState({Password})}/>
              </Item>
              <Button block 
              onPress={()=>this.login()}
